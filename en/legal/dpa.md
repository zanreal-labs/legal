...
description: Learn about ZanReal' Data Processing Agreement (DPA) policy.
...
2. **ZanReal as Controller.** To the extent that any Service-Generated Data is considered Personal Data and as to any Contact Data, ZanReal is the controller with respect to such data and will Process such data in accordance with its [Privacy Policy](/legal/privacy).
...
3. **Cross Border Data Transfer Mechanism.** To the extent that Customer's use of the Services requires an onward transfer mechanism to lawfully transfer personal data from a jurisdiction (i.e., the European Economic Area ("**EEA**"), the United Kingdom ("**UK**"), Switzerland or any other jurisdiction listed in [Schedule 3](#schedule-3)) to ZanReal located outside of that jurisdiction (a "**Transfer Mechanism**"), the terms and conditions of [Schedule 3](#schedule-3) (Cross Border Transfer Mechanisms) will apply.
...
ZanReal has a process that allows individuals to exercise their privacy rights, as described in ZanReal' Privacy Notice available at [Privacy Policy](/legal/privacy).
...
1. **Standard Contractual Clauses.** To the extent that Customer's use of the Services requires an onward transfer mechanism to lawfully transfer personal data from the EEA, UK, or Switzerland to ZanReal located outside of those jurisdictions, the Standard Contractual Clauses will apply to such transfers. The parties agree that:
   a. Customer is the data exporter and ZanReal is the data importer;
...
2. **Data Protection Officer.** Customer may contact ZanReal' Data Protection Officer at [privacy@zanreal.com](mailto:privacy@zanreal.com).
...
1. **CCPA Compliance.** Where ZanReal processes personal information subject to the California Consumer Privacy Act (CCPA), ZanReal will:
